...
LABEL version="0.1"
LABEL description="Parcel CSI Driver Image"

ARG GOROOT=/usr/local/go
ARG CSI_DRIVER_SRC_DIR="/go/src/github.com/iychoi/parcel-csi-driver/"
...
# Setup CSI Driver
COPY --from=parcel_csi_driver_build:latest ${CSI_DRIVER_SRC_DIR}/bin/parcel-csi-driver /bin/parcel-csi-driver
# Setup iRODS FUSE
...
ENTRYPOINT ["/bin/parcel-csi-driver"]
